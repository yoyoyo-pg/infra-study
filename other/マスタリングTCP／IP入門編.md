...
- 最近ではADSLやケーブルテレビなどを使ったインターネット接続でPPPoE（PPP over Ethernet）として利用されるように
  - PPPoEによりイーサネット上でコネクションを管理すれば、PPPの認証機能などを利用してプロバイダが顧客の管理をしやすく
...
- LANなどのような構内の接続ではなく、外部と接続する場合に使用する講習通信サービスについて解説
